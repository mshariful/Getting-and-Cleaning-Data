...
I have written a R script "run_analysis.R" which produce a tidy data set (as desired by the course instructor)
if the script is run/executed from the same data folder where run_analysis.R  is located:

Simply copy the data sets
"X_train.txt"
"y_train.txt"
...
into he same folder where run_analysis.R  is located and execute the script.

This dataset is generated in the following experient: 
